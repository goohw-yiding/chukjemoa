...
${/* 🛒 새 자리 — 「하는 것」 바로 뒤. 여기까지 읽은 사람은 «갈지 말지»를 이미 정했고,
      아래로는 근처 목록이 길게 이어진다. 홈(본문 2,541자 지점)이 2.64%인데 여기는 약 1,100자다. */''}
...
${/* 🛒 2026-09-15 — 구매박스를 «위»로 옮겼다. 여기(본문 87% 지점)에 있던 것이다.
      실측: 375px 휴대폰에서 10.4화면 아래 · GA4 28일 축제상세 조회 2,914 → 클릭 3 = 0.10%
      (홈 2.64%의 1/26). 오일장에서 겪은 것과 같은 병이고, 같은 처방을 쓴다.
      새 자리는 「하는 것」 뒤 — 언제·어디서·얼마인지 알고, 뭘 하는 축제인지도 안 직후다.
      그 아래는 근처 가볼 곳·맛집·카페·숙소로 이어지는 긴 목록이라 아무도 끝까지 안 내려간다. */''}
