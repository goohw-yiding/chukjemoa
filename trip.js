...
const L = {
  ...
  ja: {
    ...
    tier: {
      first: { h1: '韓国はじめて — どこへ行くか', lead: '外国人訪問者が最も多い市郡区です。初回はこれで正解です。案内表示も交通も整っていて、短い日程を迷うことに使わずに済みます。', title: '韓国はじめての旅 — 訪問データで選ぶ行き先', desc: '外国人訪問者が最も多い韓国の12地域と、そこに実際にあるもの（観光地・歩く道・自然・混雑度）。登録データと繁忙期倍率をもとに選びました。' },
      second: { h1: '韓国2回目 — 次はどこへ', lead: 'ソウル・釜山・済州は済んだ方へ。韓国人自身がよく行くのに、外国人訪問ランキングの上位には出てこない場所を集めました。行きやすさは残しつつ、初回とは違う韓国です。', title: '韓国2回目 — ソウル・釜山の次に行く場所', desc: '韓国2回目の行き先。韓国人の訪問は多いのに外国人ランキングでは下位、または圏外の地域から選びました。登録観光地数と繁忙期倍率のデータをもとにしています。' },
      third: { h1: '韓国3回目以降 — 観光客がほぼいない場所', lead: '外国人訪問ランキングに名前すら出てこない地域です。韓国人は行きます（繁忙倍率がそれを示しています）。英語はあまり通じません。その代わり、素の韓国があります。', title: '韓国3回目 — 外国人がまだ見つけていない場所', desc: '外国人訪問ランキング圏外なのに、季節になると韓国人が集まる地域。本当に静かな場所を探すリピーター向けに、繁忙期倍率と登録データから選びました。' }
    },
  ...
  zh: {
    ...
    hubDesc: '用真实访客数据选出的韩国目的地。第一次去外国人已经在去的地方，第二三次去韩国人扎堆而外国人还没发现的地方。依据登记景点数与旺季倍数排名。',
    tier: {
      first: { h1: '第一次来韩国 — 去哪儿', lead: '这些是全国接待外国游客最多的市郡区。第一次来就该这样：标识齐全、交通方便，不用把短短几天花在摸索上。', title: '第一次来韩国 — 用访客数据选行程', desc: '韩国接待外国游客最多的12个地区，以及每个地区实际有什么：景点、步道、自然景观和拥挤程度。基于官方登记数据与旺季倍数排名选出。' },
      second: { h1: '第二次来韩国 — 接下来去哪儿', lead: '首尔、釜山、济州都去过了。这些是韩国人自己常去、却没进外国游客排行前列的地方。既好走，又和第一次不一样。', title: '第二次来韩国 — 首尔釜山之外去哪儿', desc: '第二次来韩国的目的地。从韩国人访问量大、但外国游客排名靠后或未上榜的地区中选出，依据登记景点数量与旺季倍数数据。' },
      third: { h1: '第三次以后 — 几乎没有游客的地方', lead: '这些地区根本没出现在外国游客排行里。韩国人会去——旺季倍数证明了这一点。英语不太通，但你会看到没有被观光化的韩国。', title: '第三次来韩国 — 外国游客还没发现的地方', desc: '未进入外国游客排行、但到了季节韩国人就涌入的地区。适合想找真正清静地方的回头客，依据旺季倍数与登记景点数据选出。' }
    },
  ...
  tw: {
    ...
    hubDesc: '用真實旅客資料選出的韓國目的地。第一次去外國人已經在去的地方，第二三次去韓國人聚集而外國人還沒發現的地方。依據登記景點數與旺季倍數排名。',
    tier: {
      first: { h1: '第一次來韓國 — 去哪裡', lead: '這些是全國接待外國旅客最多的市郡區。第一次來就該這樣：標示清楚、交通方便，不用把短短幾天花在摸索上。', title: '第一次來韓國 — 用旅客資料選行程', desc: '韓國接待外國旅客最多的12個地區，以及每個地區實際有什麼：景點、步道、自然景觀與擁擠程度。依官方登記資料與旺季倍數排名選出。' },
      second: { h1: '第二次來韓國 — 接下來去哪裡', lead: '首爾、釜山、濟州都去過了。這些是韓國人自己常去、卻沒進外國旅客排行前段的地方。好走，又和第一次不一樣。', title: '第二次來韓國 — 首爾釜山之外去哪裡', desc: '第二次來韓國的目的地。從韓國人造訪量大、但外國旅客排名靠後或未上榜的地區中選出，依據登記景點數量與旺季倍數資料。' },
      third: { h1: '第三次以後 — 幾乎沒有觀光客的地方', lead: '這些地區根本沒出現在外國旅客排行裡。韓國人會去——旺季倍數證明了這件事。英語不太通，但你會看到沒有被觀光化的韓國。', title: '第三次來韓國 — 外國旅客還沒發現的地方', desc: '未進入外國旅客排行、但到了季節韓國人就湧入的地區。適合想找真正清靜地方的回頭客，依據旺季倍數與登記景點資料選出。' }
    },
