...
//
// ⛔ 2026-09-14 저녁 — **결국 이걸 안 썼다.** 코레일이 「KTX 시간표」·「KTX 운임표」를 공식 XLSX 로
//    그냥 배포하고 있었고(letskorail 「열차운임/시간표」 게시판), 그게 활용신청도 키도 필요 없고
//    소요시간과 운임을 «한꺼번에» 준다. → `parse-train-timetable.py` 가 실제로 쓰는 길이다.
//    이 파일은 남겨 둔다 — 시간표가 날짜별로 필요해지면(임시열차·명절 증편) 그때는 이쪽이 맞다.
//
// 실행:
