...
.nearby-btn{border:1.5px solid #ffd0be;background:#fff;color:#e0502f;border-radius:20px;padding:8px 18px;font-size:.9rem;cursor:pointer;font-weight:800;transition:all .15s;box-shadow:0 2px 8px rgba(255,90,60,.12);font-family:inherit}
.nearby-btn:hover{border-color:#ff5a3c;transform:translateY(-1px)}
.nearby-btn.done{background:linear-gradient(135deg,#ff5a3c,#ff9a3c);color:#fff;border-color:transparent}
...
.testbanner{display:block;margin:34px 0 6px;background:linear-gradient(115deg,#3b1a5c,#7a2fbf 55%,#ff5a3c);color:#fff;border-radius:18px;padding:26px 28px;box-shadow:0 8px 24px rgba(122,47,191,.3);transition:transform .18s}
...
.quiz .opts button{border:1.5px solid #eee3da;background:#fdfaf7;border-radius:14px;padding:15px 18px;font-size:1rem;font-weight:700;color:#374151;cursor:pointer;transition:all .15s;font-family:inherit}
...
.quiz .dots i{width:9px;height:9px;border-radius:50%;background:#e9e0d8}
...
.rec{display:block;text-align:left;background:#fdfaf7;border:1.5px solid #f0e6dc;border-radius:14px;padding:14px 17px;margin-bottom:10px;transition:all .15s}
.rec:hover{border-color:#ffb59d;transform:translateY(-1px)}
...
.share-row .sh2{background:#ff5a3c;color:#fff}
